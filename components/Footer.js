        ...
        <div className="md:w-2/3 w-full px-4 text-white flex flex-col">
          ...
          <div className="flex mt-8 flex-col md:flex-row md:justify-between">
            ...
            <div className="w-44 pt-6 md:pt-0">
              <button className="hover:bg-slate-600 bg-red-500 justify-center text-center rounded-lg shadow px-10 py-3 flex items-center">
                Contact US
              </button>
            </div>
          </div>
          <div className="flex flex-col">
            <div className="flex mt-24 mb-12 flex-row justify-between">
              <h1 className="font-bold font-mono text-2xl">BASECODE</h1>
              <Link
                href="/"
            ...
            <p className="w-full text-center my-12 text-gray-600">
              Copyright © 2023 MADE BY BASECODE
            </p>
          </div>
        </div>
      </div>
